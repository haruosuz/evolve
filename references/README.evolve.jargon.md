...
https://sci-tech.ksc.kwansei.ac.jp/~tohhiro/Systematics/Systematics-2-23.pdf
外群の利⽤
研究対象である群：内群 (ingroup)
...
根を導⼊するために種5(爬⾍類）を外群として導⼊

外群としてパラログを利⽤して３つのドメインの根を決定したのは
宮⽥隆のグループの研究 (Iwabe et al. 1989)
